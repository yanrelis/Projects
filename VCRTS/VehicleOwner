	...
	public class VOServer {
		...
		public static void main(String[] args) throws IOException {
			...
			if (tempStr.equals("yes")) {
				...
				JOptionPane.showMessageDialog(new HomePage().new VehicleOwnerHome().getVehicleOwnerHome(), "Your request was denied");
			}
			else {
				System.out.print("String not being recognized");
			}
